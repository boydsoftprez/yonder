...
/*
 * Sony IMX462 bring-up driver for the Rockchip vendor 6.1 kernel.
...
static int imx290_ctrl_init(struct imx290 *imx290)
{
	...
	v4l2_ctrl_new_std(&imx290->ctrls, &imx290_ctrl_ops,
			  V4L2_CID_ANALOGUE_GAIN, 0, 98, 1, 0);
...
static const struct of_device_id imx290_of_match[] = {
 { .compatible = "sony,imx462lqr", .data = &imx290_models[IMX290_MODEL_IMX290LQR] },
 { }
};
