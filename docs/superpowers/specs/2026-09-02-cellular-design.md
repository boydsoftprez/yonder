...
**The watchdog is moved onto it.** Recorded as K-42; no requirement changes.
...
**One known issue is added.** K-42: the fallback watchdog accepts an interface that holds
