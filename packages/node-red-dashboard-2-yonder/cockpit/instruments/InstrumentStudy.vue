...
<style>
/* Match the widest face (190:137) to one of six rows, allowing for chrome,
   bank padding and button borders. Narrow the bank instead of adding gutters. */
.instrument-study{height:100dvh;background:#030708;color:#fff;--cockpit-height:calc(100dvh - 46px);--study-column:clamp(148px,calc((100dvh - 175px) * 1.387 / 6 + 15px),220px);font-family:Arial,sans-serif}
...
@media(max-width:1100px){.study-toolbar>span{display:none}.study-toolbar b{margin-right:auto}}
