 ...
 * change that can affect nothing reachable — the palette, today the one
 * exemption `affectsReachability()` grants, or a document that did not
 * change at all — is kept outright (R-CFG-12), and the engine records that
 * `confirmed` with nobody asked. The pill shows for it too, and that is the claim it makes:
